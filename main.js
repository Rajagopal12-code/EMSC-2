...
function getResults() {
//gets value of input
let search = element("input").value;
...
if (search.length > 1) {
    ...
    if (counter < 10) {
        ...
        element("results").innerHTML +=
            "<div class='item' onclick='displayData(\"" +
            x +
            "\")'><p>" +
            x +
            "</p></div>";
...
element("results").style.display = "block";
}
